...
public class PostBO {
	...
	public int updatePost(int postId, int userId, 
			String userloginId, String subject, String content, MultipartFile file) {
		// 기존 글을 먼저 가지고 온다. (post 존재 유무 확인, 이미지가 교체될 때 기존 이미지를 제거하기 위해)
