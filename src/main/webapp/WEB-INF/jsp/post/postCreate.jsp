...
<div class="d-flex justify-content-center">
	...
	<div class="d-flex justify-content-between my-3">
		...
		<div class="d-flex justify-content-end">
			<button type="button" id="clearBtn" class="btn btn-success">모두 지우기</button>
...
$(document).ready(function(){
	//목록 버튼 클리 => 글 목록 화면으로 이동
	$('#postListBtn').on('click', function(){
		location.href = "/post/post_list_view"; //앵커태그는 마우스 올렸을 때 주소가 보이지만 버튼은 안보임
	});
	//모두 지궁기 버튼 클릭 => 제목, 글 지운다.
	...
	$('#postCreateBtn').on('click', function(){
		...
		//alert(file); // 파일이 업로드 된 경우 확장자 체크
		if (file != ''){
